# Proyecto Integrador: Secuencia Didáctica con Inteligencia Artificial

> Una propuesta pedagógicamente fundamentada para diseñar clases donde la IA valida el aprendizaje, no lo sustituye.
...
El proyecto está publicado en GitHub Pages. Abre el sitio en tu navegador:
...
git clone https://github.com/arkev/Secuencia_Didactica_IA.git
...
|----------|-----------|---------------------------|
| Entrega a tiempo | 5% | Datos de la entrega (portada) |
| Objetivos claros y coherencia | 20% | Sección 02 "Objetivos de aprendizaje" |
| IA reflexiva y pertinente | 20% | Sección 03 "Mapeo a Bloom" y "Filtro pedagógico" |
| Evaluación ética de recursos | 20% | Sección 04 "Evaluación ética · Transparencia" |
| **Reflexión crítica y profunda** | **35%** | **Sección 05 "Reflexión final"** |
...
Este proyecto es parte del **Taller: Cómo diseñar clases efectivas con IA educativa (05-2026)** impartido en la Universidad de Montemorelos.

### Competencia desarrollada
> *Integrar los aprendizajes del taller en el diseño de una secuencia didáctica asistida por inteligencia artificial, evidenciando la toma de decisiones pedagógicas y éticas fundamentadas, así como la aplicación reflexiva de la IA en un contexto real de práctica docente.*

### Marcos teóricos aplicados
- **Taxonomía de Bloom (Anderson & Krathwohl, 2001):** Para mapear niveles cognitivos
- **Filtro Pedagógico para usar IA:** Las 6 preguntas que guían decisiones
- **Diseño Centrado en el Usuario (David Travis):** Libro base de la actividad
...
Este es un proyecto de entrega académica, pero estás invitado a:
- Reportar errores o problemas de visualización
- Sugerir mejoras en la estructura o el contenido
- Adaptar el diseño a tu contexto educativo

Para contribuir:
1. Fork el repositorio
2. Crea una rama para tu mejora (`git checkout -b feature/mejora`)
3. Haz commit de tus cambios (`git commit -am 'Mejora: descripción'`)
...
Este proyecto está bajo licencia **CC BY-SA 4.0** (Creative Commons Atribución-CompartirIgual 4.0).

Eres libre de:
- **Copiar y redistribuir** el material
- **Adaptar y remixar** para tus propias clases

Siempre que:
- **Atribuyas** el trabajo original
...
**Allen Kevin Zapien Zamora**  
Docente de Fundamentos del Diseño  
Licenciatura en Diseño Gráfico  
Universidad de Montemorelos

**Contacto:** [allenzapien@um.edu.mx]

---

## 📞 Soporte

¿Preguntas sobre el proyecto? Abre un **Issue** en GitHub o contacta directamente.

---

## 🙏 Agradecimientos

- Universidad de Montemorelos, por el espacio y la confianza
